...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql = "UPDATE jobs SET title = :title, department = :department, status = :status WHERE id = :id";
    $stmt = $pdo->prepare($sql);
    $stmt->execute([
        ':title' => $title,
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                <h2 class="my-4">Edit Job Posting</h2>
                <form method="POST" action="edit_job.php?id=<?php echo $id; ?>">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="department" name="department" value="<?php echo htmlspecialchars($job['department']); ?>" required>
                    </div>
                    <div class="mb-3">
