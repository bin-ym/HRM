...
<body>
  ...
  <div class="container-fluid my-4">
    ...
    <div class="row">
      ...
      <!-- New Card for External Candidates -->
      <div class="col-lg-4 col-md-6 text-center mb-4">
        <div class="card">
          <img src="assets/images/candidate.jpg" class="card-img-top" alt="External Candidate">
          <div class="card-body">
            <h5 class="card-title">External Candidates</h5>
            <p class="card-text">Apply for job openings, track application status, and schedule interviews.</p>
